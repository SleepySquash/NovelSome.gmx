/*
**  Usage:
**      pointbutton(x,y,str,color1,color2,color3,def,back)
**
**  Arguments:
...
*/
    ...
    if (def) {draw_circle_colour(bl-string_height("A"),_yy,string_height("A")/2-1,c_white,c_white,0);
        draw_circle_colour(bl-string_height("A"),_yy,string_height("A")/2-1,c_black,c_black,1);} else {
        draw_circle_colour(bl-string_height("A"),_yy,string_height("A")/2-1,c_black,c_black,0);
        draw_circle_colour(bl-string_height("A"),_yy,string_height("A")/2-1,c_white,c_white,1);}
