animation_initl(); wasAnimated=0; currentAnim=argument0; cranim=argument0;
if (!file_exists(working_directory+argument0)) {return 0; exit;}
lineCount=0; inRead=file_text_open_read(working_directory+argument0); if (inRead==-1) {return 0; exit;}
